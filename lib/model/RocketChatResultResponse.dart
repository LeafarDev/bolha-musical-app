...
abstract class RocketChatResultResponse
    implements
        Built<RocketChatResultResponse, RocketChatResultResponseBuilder> {
  RocketChatResultResponse._();

  factory RocketChatResultResponse(
          [updates(RocketChatResultResponseBuilder b)]) =
      _$RocketChatResultResponse;

  @nullable
  @BuiltValueField(wireName: 'messages')
  BuiltList<MessageObj> get messages;
  ...
  String toJson() {
    return json.encode(standardSerializers.serializeWith(
        RocketChatResultResponse.serializer, this));
  }
