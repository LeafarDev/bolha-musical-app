...
abstract class Message implements Built<Message, MessageBuilder> {
  ...
  static Message fromJson(String jsonString) {
    ...
    Message token = standardSerializers.deserializeWith(Message.serializer, parsed);
    return token;
  }

  String toJson() {
    return json.encode(standardSerializers.serializeWith(Message.serializer, this));
  }
